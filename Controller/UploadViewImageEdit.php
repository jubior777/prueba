        ...
        for (var i = 0, f; f = files[i]; i++) {
            ...
            reader.onload = (function (theFile) {
                return function (e) {
                    ...
                    span.innerHTML = ['Nombre: ', escape(theFile.name), ' || Tamaño: ', escape(theFile.size), ' bytes || type: ', escape(theFile.type), '<br /><img class="thumb" src="', e.target.result, '" title="', escape(theFile.name), '"style="width:100%;"/><br />'].join('');
