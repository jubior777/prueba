...
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <font size="2"> <center> <b>BROASTERIA ADSMIMED</b>  </center></font>';
 

  echo '<center>   El mejor pollo de la zona </center> ';

  
   echo '<center> Suscursal  Av. La Pradera </center> ';
   echo '<center>   N&ordm; 1111 - Telefono : (1) 5172525  </center> ';
 
   echo '<center>  BOGOTA DC</center> ';
...
<?php
   ...
   echo '<table cellpadding="0"  cellspacing="0" width="260">';
	...
	for ($i=0; $i<$numfilas; $i++)
	{
		...
		echo '<tr><td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nit/CC :</b>'.$fila['cc'].'</td></tr>';
		$nit=$fila['cc'];
		$efectivo=$fila['monto'];
		$efectivoT=$efectivo;
	...
	$CodigoControl = new CodigoControl($autorizacion,$factura,$nitcc,$fechaa,$monto,$llave);
...
Son <?php echo num_letra($num, false, true)?> <?php echo '0/100'; echo '&nbsp;'; echo'Pesos ';?>
</td></tr></table>
...
<?PHP 
   ...
   echo'--------------------------------------------------------------';
   echo '<center> &nbsp;&nbsp; Gracias por su Visita !! </center>';
