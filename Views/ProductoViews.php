...
<section id="main-content">
    <section class="wrapper">
        ...
        <header class="panel-heading"> Lista de Productos </header>
                    ...
                    while ($product = mysqli_fetch_array($allProducto)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger" onclick="eliminarCliente(<?PHP echo $product["0"]; ?>)"><i class="icon_close_alt2"></i></button>
                            </td>
                        </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <section class="panel">
                                                        <img src="<?PHP echo $urlViews . $product['imagen']; ?>" width="230"
                                                             height="230">
                                                        <br><br>
    ...
    function eliminarCliente(idborrar) {
        var id = idborrar;
            ...
            if (result.isConfirmed) {
                ...
                var url = '<?php echo $urlController ?>RegistroProducto.php?idborrar='+id+'&usuarioLogin=<?PHP echo $usuario; ?>&passwordLogin=<?PHP echo $password; ?>'
                ...
                request.onreadystatechange = function() {
                    if(request.readyState == 4 && request.status == 200) {
                        window.location = '<?php echo $urlController ?>RegistroProducto.php?idborrar='+id+'&usuarioLogin=<?PHP echo $usuario; ?>&passwordLogin=<?PHP echo $password; ?>'
                        //location.reload();
                    }
                }
            }
